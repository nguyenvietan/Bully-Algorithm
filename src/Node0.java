...
public class Node0 implements BullyInterface {
	...
	static final String thisNode = Node0_IP;
	...
	public static void main (String[] args) {
		...
		try {
                        ...
                        System.err.println("Node0 ready");
			...
			if (thisNode.equals(initNode)) {
                        ...
                        System.err.println("Node0 exception: " + e.toString());
                        e.printStackTrace();
                }
